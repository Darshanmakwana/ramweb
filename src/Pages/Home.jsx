    ...
    >
      ...
      <div className="space-y-2 relative z-10">
        {step.details.map((detail, idx) => (
          ...
          >
            <i className="fas fa-check-circle mr-3 text-white/70 
...
const interns = [
    { name: "Nandani Patel", role: "Full Stack", image: "https://placehold.co/100x100", alt: "Image of Nandani Patel" },
    { name: "Nidhi Parmar", role: "Ui/Ux", image: "https://placehold.co/100x100", alt: "Image of Nidhi Parmar" },
    { name: "Kalpesh", role: "React JS", image: "https://placehold.co/100x100", alt: "Image of Kalpesh" },
    { name: "Parth Goswami", role: "React JS", image: "https://placehold.co/100x100", alt: "Image of Parth Goswami" },
    { name: "Jeel Patel", role: "Data Analysis", image: "https://placehold.co/100x100", alt: "Image of Jeel Patel" },
    { name: "Zankhna", role: "React JS", image: "https://placehold.co/100x100", alt: "Image of Zankhna" },
    { name: "Mohit Prajapati", role: "React Native", image: "https://placehold.co/100x100", alt: "Image of Mohit Prajapati" }
];
  ...
  useEffect(() => {
    ...
    const generateBubbles = () => {
      const newBubbles = Array.from({ length: 4 }, (_, index) => ({
        ...
        x: Math.random() * window.innerWidth,
        y: Math.random() * 500,
        size: `w-${Math.floor(Math.random() * 20 + 20)} h-${Math.floor(Math.random() * 20 + 20)}`,
        color: 'bg-[#ffff]/40',
        trajectory: {
          ...
          <div className="container relative z-10 max-w-6xl mx-auto">
              ...
              >
                  ...
                  >
                      ...
                      <div className="absolute -inset-6 bg-gradient-to-br from-blue-100/20 to-purple-100/20 
                          rounded-3xl opacity-50 blur-2xl group-hover:opacity-70 transition-all duration-500"></div>
                      ...
                      >
                          <FontAwesomeIcon icon={faChartLine} className="text-4xl"></FontAwesomeIcon>
                      </motion.div>
                  </motion.div>
                  ...
                  >
                      ...
                      >
                          ...
                          <h1 className="text-4xl font-bold mb-4 text-gray-900 leading-tight">
                              Reasons to <span className="text-blue-600">Trust Our Expertise</span>
                          </h1>
                          <div className="h-1 w-24 bg-blue-600 rounded-full mb-4"></div>
                      </motion.div>

                      <p className="text-gray-600 mb-6 leading-relaxed">
                          We provide tailored, all-in-one website solutions that blend expert design, cutting-edge technology, and comprehensive support to help your business shine online.
                      </p>
                          ...
                          {[
                              {
                                  ...
                                  description: "Our experts know their stuff and will make sure your website looks great and works well."
                              },
                              {
                                  icon: faHeadset,
                                  color: "purple",
                                  title: "Dedicated Support",
                                  description: "We offer continuous support and make sure everything runs smoothly from start to finish."
                              },
                              {
                                  icon: faPaintBrush,
                                  color: "blue",
                                  title: "Custom Design",
                                  description: "We create websites that perfectly fit your brand and achieve your unique goals."
                              }
                          ].map((feature, index) => (
                              <motion.div 
                                  key={feature.title}
                      ...
                      >
                          ...
                          >
                              ...
                              <FontAwesomeIcon icon={faArrowRight} className="transition-transform group-hover:translate-x-1"></FontAwesomeIcon>
                          </motion.button>
                      </motion.div>
                  </motion.div>
              </motion.div>
                ...
                {[
                    ...
                    >
                        <div className="relative overflow-hidden">
                            ...
                            />
                            <div className="absolute inset-0 bg-[#034067]/70 
